...
public class swirlingJumpController : BaseController {	//re-evaluation after its performance here in the logic.
	...
	//--Hovering activation in ground-state
		...
		private float swirlBufferLength = 2.0f;
	...
	private float swirlingGravityCoefficient = 0.252f;
	//--Stick swirlingvariables
		public Vector3 swirlDirection;
		public float lastRadians, currentRadians, interval;
		private bool sign;
		private float RotationResolution = Mathf.PI/16.0f;
		private float RotationSkip = Mathf.PI/10.0f;
	...
	void Awake ()
	{
		...
		headEmblem.edgeLength = headEmblem.maxEdge;	
